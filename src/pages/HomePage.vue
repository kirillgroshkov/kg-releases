<template>
  <div>
    ...
    <div class="copy1">&lt;/&gt; with <3 in <span class="flag-se"></span> by <a href="https://twitter.com/kirillgroshkov" target="_blank">@kirillgroshkov</a></div>
